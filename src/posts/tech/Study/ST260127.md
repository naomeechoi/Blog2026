...
예) Engine.lib!<img src="/Img/link_lib.png" alt="Engine.lib" style="width:50%;" />
<br></br>
4) 프로젝트 속성 -> 링커 -> 일반 -> 추가 라이브러리 디렉터리에 lib 파일을 찾을 경로를 넣어준다.<br></br>
예) ..\Library\Engine\$(Platform)\$(Configuration)\ <img src="/Img/add_dir_lib.png" alt="라이브러리경로추가" style="width:50%;" />
<br></br>
...
예) xcopy ..\Library\Engine\$(Platform)\$(Configuration)\Engine.dll $(OutDir)\ /y /i <img src="/Img/after_build.png" alt="빌드후이벤트" style="width:50%;" />
</details>
